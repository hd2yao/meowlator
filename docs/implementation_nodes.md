...
| N006 | 2026-02-22 | 0.5.0 | Pain Risk Reminder | Added optional pain-risk scoring branch, API risk output schema, disclaimer enforcement in copy generation, and mini-program risk card rendering (non-diagnostic). | `make test` | `TBD` |
