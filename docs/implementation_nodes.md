...
| N007 | 2026-02-23 | 1.0.0 | Release Readiness | Added session auth, rate limit/signature guard, model rollout admin APIs, release migrations, cleanup task, and v0.6 training gate scripts for white-list launch readiness. | `make test` | `TBD` |
