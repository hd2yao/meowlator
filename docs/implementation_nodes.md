...
| N005 | 2026-02-22 | 0.4.0 | Data Pipeline Automation | Added feedback cleaning, weighted manifest builder, daily active-learning task generator, training resume support, and confusion matrix artifact output. | `cd ml/training && python3 -m unittest discover -s scripts -p 'test_*.py'` + `make test` | `TBD` |
